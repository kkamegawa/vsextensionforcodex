...
- Publisher: `kkamegawa` (matches the Marketplace publisher display name; the `KazushiKamegawa` segment in the VSIX ID below is just an opaque identity token, not the publisher) / VSIX ID: `relaycodexforvs.KazushiKamegawa.9527382d-b5f4-455c-97bd-a8da43e7c835`
